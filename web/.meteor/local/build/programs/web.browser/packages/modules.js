...
install("reactive-dict");                                                    // 89
install("kadira:flow-router");                                               // 90
install("blaze-html-templates");                                             // 91
install("spacebars");                                                        // 92
install("templating");                                                       // 93
install("kadira:blaze-layout");                                              // 94
install("webapp");                                                           // 95
install("livedata");                                                         // 96
install("hot-code-push");                                                    // 97
install("launch-screen");                                                    // 98
install("ui");                                                               // 99
install("autoupdate");                                                       // 100
install("mdg:validation-error");                                             // 101
